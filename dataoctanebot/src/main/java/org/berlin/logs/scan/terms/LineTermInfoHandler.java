...
public class LineTermInfoHandler {
     ...
     * @return
     */
    public boolean processSearchTerm(final String line, final String searchTermRegex, final boolean onlyReturnValidTime) {
        if (line == null) {
            return false;
        }
    ...
    public boolean processTime(final String line) {        
        ...
        final String tmpj = String.format(FORMAT_TIME, this.year, this.month, this.day, this.hour, this.minute, this.seconds);
    ...
    public boolean processAtAllLines(final String line, final String searchTermRegex, final boolean onlyReturnValidTime) {
