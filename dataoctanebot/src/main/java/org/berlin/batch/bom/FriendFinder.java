...
public class FriendFinder {
	...
	/**
	 * Levels deep in the friend find. Default value 3.
	 */
	private int maxLevelsDeep = 3;

	/**
	 * Max number of new user node instances. Default 20-80.
	 */
	...
	public void connect(final BotDataUser user, final GenericTree tree, final int levelDeep) {
		...
		logger.info("<<" + levelDeep + ">> Initiating network request, current total requests : "
				+ this.stats.net().get() + " nodeInstances=" + nodeInstances);
