...
public class DataMessageFinder {
	...
	/**
	 * Force the type of seed terms to use. 1,2,3
	 * If '-1' then ignore the rule.
	 */
	...
	protected ContinueRequestData parseResults(final SessionFactory sf, final String queryTerm, final BotMessagesDAO dao, Session session, final JsonNode resultsRoot, final int offsetId) {
	...
	/**
	 * @param forceRequestRule the forceRequestRule to set
	 */
	 ...
	 * Basic seed words.
	 */
	public static final String POPULAR_TERMS [] = {		
		"government", "company", "woman", "problem", "family", "problem", "country", "important",
		"headquarters", "license", "grandfather", "justice", "entertainment", "tech", "crazy",
		"love", "hate", "breaking news", "headline news", "dates", "places", "rebel",
		"firefox", "games", "legalization", "Austrian", "capitalism", "destruction", "free market", 
		"violence", "hoods", "chrome", "google glass", "playstation", "secure", "washington",
		"technology", "programming", "robots", "cyborg", "life", "obama", "news", "school", "science", "engineering", "data",
		"google", "math", "science", "english", "japan", "china", "android", "stocks", "bonds", 
		"russia", "information", "planets", "whales", "diet", "health", "medicine", "cancer", "nationalized", "health care",
		"java", "microsoft", "bing", "xbox", "light", "new york", "PHYSICIAN", "placebo", "word",
		"music", "internet", "books", "learning", "violence", "war", "routine","hiv", "Aspirin", "poetry",
		"church", "food", "water", "Jefferson", "constitution", "security", "century", "future",
		"north korea", "iran", "persian", "oscars", "argo",	"nyse", "trends", "aliens", "war", "art", "drawing",
		"lessons", "greece", "london", "winter", "guns", "woman", "men", "korea", "international", "cnn",
		"mexico", "america", "Chesapeake", "think", "clinton", "important", "immigration", "economy", "liberals",
		"survivors", "boeing", "resources", "hamas", "wired", "airport", "conspiracy",
		"Nationalized", "health-care", "vote", "away", "reality", "instituted", "responsible", 
		"parents", "providers", "corporate", "officers", "market", "computers",
		"country", "angry", "founders", "congress", "senator", "senate"
	};
