...
public class PercentEscaper extends UnicodeEscaper {
	...
	/**
	 * A string of characters that do not need to be encoded when used in URI query
	 * strings, as specified in RFC 3986. Note that some of these characters do need
	 * to be escaped when used in other parts of the URI.
	 */
	 ...
	 *
	 * @param safeChars
	 *            a non null string specifying additional safe characters for this
	 *            escaper (the ranges 0..9, a..z and A..Z are always safe and should
