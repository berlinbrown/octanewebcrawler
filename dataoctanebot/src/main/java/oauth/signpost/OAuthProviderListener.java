...
public interface OAuthProviderListener {
	...
	/**
	 * Called when the server response has been received. You can implement this to
	 ...
	 * @return returning true means you have handled the response, and the provider
	 *         will return immediately. Return false to let the event propagate and
	 *         let the provider execute its default response handling.
	 * @throws Exception
	 */
