...
public class SignatureBaseString {
	...
	/**
	 * Constructs a new SBS instance that will operate on the given request object
	 * and parameter set.
	 * 
	 * @param request
	 *            the HTTP request
	...
	/**
	 * Builds the signature base string from the data this instance was configured
	 * with.
	 * 
	 ...
	 * as per OAuth spec section 9.1.1.
	 * 
	 * @param parameters
